        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_name', models.CharField(
                    choices=[('Vertebrates', 'Vertebrates'), ('Microbes', 'Microbes'), ('Metazoa', 'Metazoa'),
                             ('VectorBase', 'VectorBase'), ('Plants', 'Plants'), ('WormBase', 'WormBase'),
                             ('Compara', 'Compara'), ('Production', 'Production')], default='Vertebrates',
                    max_length=80)),
            ],
            options={
                'verbose_name': 'Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_id', models.ForeignKey(db_column='job_id', on_delete=django.db.models.deletion.CASCADE,
                                             related_name='transfer_logs', to='ensembl_dbcopy.RequestJob')),
            ],
            options={
